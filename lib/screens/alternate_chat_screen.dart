                  ...
                  FlatButton(
                    onPressed: () {
                      ...
                      if (widget.contactEmail == 'groupChat') {
                        ...
                        if (loggedInUserEmail.compareTo(receiverEmail) == 1) {
                          collectionStored =
                              '$loggedInUserEmail & $receiverEmail';
                        } else {
                          collectionStored =
                              '$receiverEmail & $loggedInUserEmail';
                        }

                        _firestore.collection(collectionStored).add({
                          'text': messageText,
...
class MessagesStream extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    var collectionCalled;
    if (senderEmail == 'groupChat') {
      collectionCalled = 'groupMessages';
    } else {
      if (currentUserEmail.compareTo(senderEmail) == 1) {
        collectionCalled = '$currentUserEmail & $senderEmail';
      } else {
        collectionCalled = '$senderEmail & $currentUserEmail';
      }
    }
    return StreamBuilder<QuerySnapshot>(
      stream: _firestore
//          .collection('$currentUserEmail & $senderEmail')
          .collection(collectionCalled)
